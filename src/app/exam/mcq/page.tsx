          ...
          <div className="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100">
            ...
            <div className="p-8">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700">
                      Once you start the exam, the timer will begin. Make sure you have enough time to complete the exam.
              ...
              <div className="flex justify-center">
                <motion.button
                  className="px-8 py-3 bg-gradient-to-r from-emerald-500 to-teal-600 text-white font-medium rounded-xl shadow-sm hover:shadow-md transition-all flex items-center space-x-2"
