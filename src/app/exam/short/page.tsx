                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700">
                      This exam requires short answers. Be concise and to the point. You can navigate between questions using the previous and next buttons.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-100">
            ...
            <div className="p-6">
              <div className="bg-gray-50 p-5 rounded-xl mb-6 border border-gray-100">
                <p className="text-lg text-gray-800 font-medium">{examDetails?.questions[currentQuestionIndex]?.statement}</p>
              </div>
              ...
              <textarea
                ...
                className="w-full h-48 border border-gray-200 rounded-xl p-4 mt-4 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all duration-200"
