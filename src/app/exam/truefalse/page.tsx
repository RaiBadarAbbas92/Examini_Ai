                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-blue-700">
                      This exam contains True/False questions. Select the correct answer for each question. You can navigate between questions using the previous and next buttons.
                    </p>
                  </div>
                </div>
              </div>
